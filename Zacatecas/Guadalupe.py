...
"""
Comprehensive 20-Year Analysis of Urban Growth in Guadalupe, Zacatecas, Mexico (2004-2024)
==========================================================================

This script creates a comprehensive visualization of urban growth in Guadalupe over a
...
def create_comparison_plot():
    ...
    """
    # Get the Region of Interest (ROI) - Guadalupe, Zacatecas coordinates
    guadalupe_point = ee.Geometry.Point([-102.52, 22.75])
    roi = guadalupe_point.buffer(10000)  # 10km buffer around center
