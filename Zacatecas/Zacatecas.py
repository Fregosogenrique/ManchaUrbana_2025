...
"""
Comprehensive 20-Year Analysis of Urban Growth in Zacatecas, Zacatecas, Mexico (2004-2024)
==========================================================================

This script creates a comprehensive visualization of urban growth in Zacatecas over a
...
output_dir = 'zacatecas_comparison'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Set up a separate directory for individual images
individual_output_dir = 'zacatecas_individual'
...
def create_comparison_plot():
    ...
    """
    # Get the Region of Interest (ROI) - Zacatecas, Zacatecas coordinates
    zacatecas_point = ee.Geometry.Point([-102.58, 22.77])
    roi = zacatecas_point.buffer(10000)  # 10km buffer around center
    ...
    export_to_geotiff(landsat_2004, 'zacatecas_2004_raw', roi, 'Zacatecas2004Raw')
    export_to_geotiff(landsat_2014, 'zacatecas_2014_raw', roi, 'Zacatecas2014Raw')
    export_to_geotiff(landsat_2024, 'zacatecas_2024_raw', roi, 'Zacatecas2024Raw')
    
    # Export visualized satellite images (for display)
    export_to_geotiff(vis_satellite_2004, 'zacatecas_2004_rgb', roi, 'Zacatecas2004RGB')
    export_to_geotiff(vis_satellite_2014, 'zacatecas_2014_rgb', roi, 'Zacatecas2014RGB')
    export_to_geotiff(vis_satellite_2024, 'zacatecas_2024_rgb', roi, 'Zacatecas2024RGB')
    
    # Export urban change maps
    export_to_geotiff(urban_change_04_14, 'zacatecas_change_2004_2014', roi, 'Change2004_2014')
    export_to_geotiff(urban_change_14_24, 'zacatecas_change_2014_2024', roi, 'Change2014_2024')
    export_to_geotiff(urban_change_04_24, 'zacatecas_change_2004_2024', roi, 'Change2004_2024')
    
    # Export urban masks for each year (for additional analysis)
    export_to_geotiff(urban_2004, 'zacatecas_urban_2004', roi, 'Urban2004')
    export_to_geotiff(urban_2014, 'zacatecas_urban_2014', roi, 'Urban2014')
    export_to_geotiff(urban_2024, 'zacatecas_urban_2024', roi, 'Urban2024')
    
    print("All GeoTIFF export tasks have been started. Files will be available in your Google Drive folder 'ManchaUrbana_Zacatecas'\n")
    ...
    print("Generating individual images for Zacatecas urban growth analysis...")
    
    # 1. Zacatecas 2004 (imagen satelital)
    img_2004, fig_2004 = display_ee_image(rgb_2004_url, 'Zacatecas 2004', save_filename="zacatecas_2004")
    plt.close(fig_2004)
    
    # 2. Zacatecas 2014 (imagen satelital)
    img_2014, fig_2014 = display_ee_image(rgb_2014_url, 'Zacatecas 2014', save_filename="zacatecas_2014")
    plt.close(fig_2014)
    
    # 3. Zacatecas 2024 (imagen satelital)
    img_2024, fig_2024 = display_ee_image(rgb_2024_url, 'Zacatecas 2024', save_filename="zacatecas_2024")
    plt.close(fig_2024)
    
    # 4. Cambio urbano 2004-2014
    img_change_04_14, fig_change_04_14 = display_ee_image(change_url_04_14, 'Urban Change 2004-2014', 
                                                        save_filename="zacatecas_change_2004_2014")
    ...
    img_change_14_24, fig_change_14_24 = display_ee_image(change_url_14_24, 'Urban Change 2014-2024', 
                                                         ...
                                                         save_filename="zacatecas_change_2014_2024")
    ...
    img_change_04_24, fig_change_04_24 = display_ee_image(change_url_04_24, 'Urban Change 2004-2024', 
                                                         save_filename="zacatecas_change_2004_2024")
    ...
    print("\nIMPORTANTE: Los archivos GeoTIFF se están exportando a tu Google Drive en la carpeta 'ManchaUrbana_Zacatecas'")
...
def main():
    ...
    print("Generating comprehensive 20-year urban growth analysis for Zacatecas, Zacatecas...")
    try:
