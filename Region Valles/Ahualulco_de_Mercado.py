...
def create_comparison_plot():
    ...
    ahualulco_point = ee.Geometry.Point([-104.02, 20.70])
    roi = ahualulco_point.buffer(10000)  # 10km buffer around center
    ...
    try:
        ...
        print(f"Error generating 2004 image URL
...
def create_comparison_plot():
    ...
    """
    # Get the Region of Interest (ROI) - Ahualulco de Mercado, Jalisco coordinates
    ahualulco_point = ee.Geometry.Point([-104.0166, 20.7167])  # Updated coordinates for Ahualulco
    roi = ahualulco_point.buffer(7000)  # 7km buffer around center, adjusted for smaller town size
    ...
    img_2024 = display_ee_image(rgb_2024_url, axes[0, 2], 'Ahualulco de Mercado 2024')
