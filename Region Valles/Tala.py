...
"""
Comprehensive 20-Year Analysis of Urban Growth in Tala, Mexico (2004-2024)
=========================================================================
...
def create_comparison_plot():
    ...
    """
    # Get the Region of Interest (ROI) - Changed to Tala coordinates
    tala_point = ee.Geometry.Point([-103.74, 20.65])
    roi = tala_point.buffer(10000)  # 10km buffer around center
    ...
    # Add a main title to the figure specific to Tala
    fig.suptitle('Urban Growth Analysis of Tala, Mexico (2004-2024)', fontsize=16, y=0.98)
