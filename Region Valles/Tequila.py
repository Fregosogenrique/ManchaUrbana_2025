...
individual_output_dir = 'Tequila_individual'
...
def create_comparison_plot():
    ...
    """
    # Definir el punto central de Tequila, Jalisco
    tequila_point = ee.Geometry.Point([-103.8367, 20.8828])

    # Crear un buffer de 7 km alrededor del punto central
    roi = tequila_point.buffer(7000)  # 7000 metros de radio
    ...
    export_to_geotiff(landsat_2004, 'Tequila_2004_raw', roi, 'Tequila2004Raw')
    export_to_geotiff(landsat_2014, 'Tequila_2014_raw', roi, 'Tequila2014Raw')
    export_to_geotiff(landsat_2024, 'Tequila_2024_raw', roi, 'Tequila2024Raw')

    # Export visualized satellite images (for display)
    export_to_geotiff(vis_satellite_2004, 'Tequila_2004_rgb', roi, 'Tequila2004RGB')
    export_to_geotiff(vis_satellite_2014, 'Tequila_2014_rgb', roi, 'Tequila2014RGB')
    export_to_geotiff(vis_satellite_2024, 'Tequila_2024_rgb', roi, 'Tequila2024RGB')

    # Export urban change maps
    export_to_geotiff(urban_change_04_14, 'Tequila_change_2004_2014', roi, 'Change2004_2014')
    export_to_geotiff(urban_change_14_24, 'Tequila_change_2014_2024', roi, 'Change2014_2024')
    export_to_geotiff(urban_change_04_24, 'Tequila_change_2004_2024', roi, 'Change2004_2024')

    # Export urban masks for each year (for additional analysis)
    export_to_geotiff(urban_2004, 'Tequila_urban_2004', roi, 'Urban2004')
    export_to_geotiff(urban_2014, 'Tequila_urban_2014', roi, 'Urban2014')
    export_to_geotiff(urban_2024, 'Tequila_urban_2024', roi, 'Urban2024')

    print(
        "All GeoTIFF export tasks have been started. Files will be available in your Google Drive folder 'ManchaUrbana_Tequila'\n")
    ...
    plt.tight_layout()
    fig_title = fig.suptitle('Análisis de Crecimiento Urbano de Tequila, Jalisco (2004-2024)',
                             fontsize=16, y=1.02)
...
def main():
    ...
    print("Generating comprehensive 20-year urban growth analysis for Tequila...")
    try:
