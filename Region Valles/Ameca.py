...
def create_comparison_plot():
    ...
    """
    # Get the Region of Interest (ROI) - Ameca, Jalisco coordinates
    ameca_point = ee.Geometry.Point([-104.02, 20.55])
    roi = ameca_point.buffer(8000)  # 8km buffer around center, adjusted for town size
...
"""
Comprehensive 20-Year Analysis of Urban Growth in Ameca, Mexico (2004-2024)
==========================================================================
...
def create_comparison_plot():
    ...
    roi = ameca_point.buffer(10000)  # 10km buffer around center
    ...
    # Function to download and display image from URL already imported above
    ...
    print(f"Comprehensive 20-year urban growth analysis saved to {os.path.join(output_dir, 'ameca_urban_comparison.png')}")
